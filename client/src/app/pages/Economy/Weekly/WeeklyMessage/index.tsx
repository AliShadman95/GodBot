            ...
            <Grid container>
              <Grid item xs={7} md={10}>
                <Typography component="p" color="main" gutterBottom>
                  Ogni volta che un utente riceve la ricompensa settimanale, il
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6} lg={6}>
              <FormControl fullWidth>
                <Input
                  id="weeklyRewardMessage"
                  name="weeklyRewardMessage"
                  label="Messaggio"
                  margin="normal"
                  control={control}
                  defaultValue={defaultValues.weeklyRewardMessage}
                  rules={{ required: true }}
                  rows={4}
                  multiline
                  helperText={
